            ...
            <Accordion className="accordion mb-5">
              ...
              <Accordion.Item eventKey="1">
                ...
                <Accordion.Body>
                  ...
                  Mise au point régulière avec le groupe afin de savoir comment
                  le projet se passe individuellement et si il y a des besoins
              ...
              <Accordion.Item eventKey="3">
                ...
                <Accordion.Body>
                  ...
                  séléctionner ou déselctionner les données sur les graphiques.
                  <br></br>
                  Mettre une image en temps que placeholder lorsqu'il n'y a pas
                  de graphiques, ajouter un loading.
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
            <Button
