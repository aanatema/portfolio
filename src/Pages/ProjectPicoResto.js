      ...
      <Container className="mt-5">
        ...
        <Row>
          ...
          <Col className="" xs={12} sm={12} md={12} lg={7}>
            ...
            <Button className="mb-5 me-5" href="/projects" variant="outline-secondary">
              Revenir aux projets
            </Button>
            <Button className="mb-5 " href="/projects/consonea" variant="outline-secondary">
              Projet suivant
            </Button>
          </Col>
        </Row>
