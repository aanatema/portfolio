          ...
          <Accordion className="accordion mb-5" flush defaultActiveKey="0">
            <Accordion.Item eventKey="0" className="accordion">
              ...
              <Accordion.Body className="accordion">
                Création d'un site e-commerce répondant aux besoins de Lauréline
                qui vient de monter son entreprise de vente de meuble
                d'occasion. Le projet se déroule sur 2 semaines avec pour seules
                contraintes de diviser l'équipe, une partie Front et une partie
                Back, et d'échanger les rôles lors de la deuxième semaine.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="1" className="accordion">
              ...
              <Accordion.Body className="accordion">
                ...
                réflexion sur les besoins du Front afin de créer les appels API
                necessaires.
                <br></br>
                ...
                équipe afin de suivre les avancées et de faciliter la transition
            ...
            <Accordion.Item eventKey="2" className="accordion">
              ...
              <Accordion.Body className="accordion">
                SEMAINE 1 <br></br>
                <strong>Back :</strong> Création de la BDD avec mySQL, création
                du serveur avec Express.<br></br>
                ...
                <strong>Front :</strong> Affichage des données de la BDD sur le
                site
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="3" className="accordion">
              ...
              <Accordion.Body className="accordion">
                L'inscritpion, le connexion, la déconnexion et la suppression de
                compte sont fonctionnels. Toutes les routes des pages
